  ...
  const links: OverlayLink[] = useMemo(
    () => [
      ...
      },
      {
        ...
        title: "후원 순위 전체 (세로)",
        desc: "같은 테마 · 전원 한 줄 세로. OBS에 브라우저 소스 하나 더 추가.",
        obsPath: `/overlay/donor-rankings/full?u={u}&host=obs`,
        testPath: `/overlay/donor-rankings/full?u={u}&host=obs&test=true`,
      },
      {
        id: "donor-rankings",
        title: "후원 순위 (상위 N)",
        desc: "테마·줌은 관리자 페이지에서 저장. OBS URL은 u·host만. 표시는 10위 고정.",
        obsPath: `/overlay/donor-rankings?u={u}&host=obs`,
        testPath: `/overlay/donor-rankings?u={u}&host=obs&test=true`,
      },
      {
