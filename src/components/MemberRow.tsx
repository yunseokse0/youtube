...
export default function MemberRow({ member, onChange, onRename, onReset, onDelete }: Props) {
  ...
  return (
    <div className="grid grid-cols-[1fr_auto_auto_auto] gap-3 items-center p-3 bg-neutral-900/60 rounded border border-white/10">
      ...
      <div className="flex items-center gap-2">
        ...
        <input
          className={`w-28 px-2 py-1 rounded bg-neutral-800/80 border border-white/10 focus:outline-none ${flash ? "animate-flashGold" : ""}`}
          inputMode="decimal"
          value={localAccount}
      ...
      <div className="flex items-center gap-2">
        ...
        <input
          className="w-28 px-2 py-1 rounded bg-neutral-800/80 border border-white/10 focus:outline-none"
          inputMode="decimal"
          value={localToon}
